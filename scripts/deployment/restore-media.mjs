...
const key=process.env.SOURCE_MEDIA_SSH_KEY??(process.env.SOURCE_MEDIA_SSH_KEY_BASE64?Buffer.from(process.env.SOURCE_MEDIA_SSH_KEY_BASE64,'base64').toString('utf8'):null);
...
try{
 ...
 delete env.SOURCE_MEDIA_SSH_KEY_BASE64;
