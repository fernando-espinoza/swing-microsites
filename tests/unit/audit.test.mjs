...
const images=Array.from({length:24},(_,i)=>`C${String(i+1).padStart(2,'0')}`).filter(id=>!['C07','C12','C08','C17','C18','C23'].includes(id)).concat(['P01','P02','P03','P04','P05','P06']);
const document=()=>`<!doctype html><html lang="en"><head><title>The Sunday Edit | Swing × John Montgomery</title><meta name="robots" content="noindex,nofollow"></head><body><main><section id="campaign"><h1>Nothing better than a Sunday tee time.</h1>${images.map(id=>`<img data-asset-id="${id}" src="/campaign/johnmontgomery/assets/test.jpg" width="10" height="15" alt="Test view">`).join('')}${`<video data-autoplay loop controls muted playsinline preload="none" poster="/campaign/johnmontgomery/assets/test.jpg" src="/campaign/johnmontgomery/assets/test.mp4"></video>`.repeat(4)}</section><section id="story"><h2>Story</h2></section><section id="products"><h2>Products</h2></section></main></body></html>`;
